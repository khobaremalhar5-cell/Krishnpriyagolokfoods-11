...
const SUPABASE_URL = 'https://mmprftkkpqllemyljtjm.supabase.co'; // Get from Supabase Dashboard
const SUPABASE_ANON_KEY = 'sb_publishable_GAxCsuByim8VxOIEyLgWZw_sPyru5i1'; // Get from Supabase Dashboard
